...
def test_unregister_services_tc91(driver):
    ...
    servicespage.input_otp("000000")
    servicespage.wait_for_result("Quay lại")
    assert servicespage.is_result_displayed("Quay lại")
...
def test_click_services_tc92(driver):
    ...
    servicespage.click_button_by_text("icBack")
    servicespage.wait_for_result("K+ data")
    servicespage.click_by_text1("K+ data")
    servicespage.wait_for_result("Chi tiết dịch vụ")
    servicespage.click_button_by_text("icBack")
    servicespage.wait_for_result("iflix")
    servicespage.click_by_text1("iflix")
    servicespage.wait_for_result("Chi tiết dịch vụ")
    servicespage.click_button_by_text("icBack")
    servicespage.wait_for_result("mGame")
    servicespage.click_by_text1("mGame")
    servicespage.wait_for_result("Chi tiết dịch vụ")
    servicespage.click_button_by_text("icBack")
    servicespage.wait_for_result("Elsa data")
    servicespage.click_by_text1("Elsa data")
    servicespage.wait_for_result("Chi tiết dịch vụ")
    servicespage.click_button_by_text("icBack")
    servicespage.wait_for_result("MobiClip")
    ...
    servicespage.wait_for_result("Chi tiết dịch vụ")
    servicespage.click_button_by_text("icBack")
    servicespage.wait_for_result("Witalk")
