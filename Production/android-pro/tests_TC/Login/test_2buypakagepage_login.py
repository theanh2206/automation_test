...
def test_create_pakage_flex_OTP_tc48(driver):
    ...
    buypakage.click_text_by_resource_id("vms.com.vn.mymobifone:id/btRegister")
    buypakage.click_text_by_resource_id("vms.com.vn.mymobifone:id/tvRegister")
    buypakage.click_button_by_resource_id("vms.com.vn.mymobifone:id/btContinue")
    buypakage.click_payment_confirm()
    # buypakage.input_otp(DEFAULT_OTP)
...
# @pytest.mark.tc48_2
# def test_cancel_pakage_flex_tc48_2(driver):
#     buypakage = BuyPakagePage(driver)
#     buypakage.click_buy_pakage()
#     buypakage.click_time_flex()
#     buypakage.click_register_button2()
...
def test_click_question_by_text_tc55(driver):
    ...
    buypakage.click_guide_by_text("Nếu thuê bao tại Việt Nam gọi cho tôi khi tôi đang chuyển vùng tại nước ngoài thì người đó có phải trả cước gọi đi quốc tế không?")
    buypakage.click_guide_by_text("Nếu thuê bao tại Việt Nam gọi cho tôi khi tôi đang chuyển vùng tại nước ngoài thì người đó có phải trả cước gọi đi quốc tế không?")
    buypakage.click_guide_by_text("Khi ra nước ngoài, tôi cần làm gì để kiểm soát được dung lượng và cước phí sử dụng dịch vụ CVQT?")
    buypakage.click_guide_by_text("Khi ra nước ngoài, tôi cần làm gì để kiểm soát được dung lượng và cước phí sử dụng dịch vụ CVQT?")
    buypakage.click_guide_by_text("Tôi đã đăng ký dịch vụ CVQT của MobiFone nhưng khi ra nước ngoài tôi không truy cập được data. Tôi phải làm gì?")
    buypakage.click_guide_by_text("Tôi đã đăng ký dịch vụ CVQT của MobiFone nhưng khi ra nước ngoài tôi không truy cập được data. Tôi phải làm gì?")
...
#1. Đăng ký bằng OTP
@pytest.mark.tc56
def test_register_pakage_tc56(driver):
    buypakage = BuyPakagePage(driver)
    buypakage.click_buy_pakage()
    buypakage.click_by_text("Chi tiết")
    buypakage.click_text_by_resource_id("vms.com.vn.mymobifone:id/tvRegister")
...
#1. Huỷ bằng OTP
@pytest.mark.tc57
def test_unregister_pakage_tc57(driver):
    buypakage = BuyPakagePage(driver)
    buypakage.click_buy_pakage()
    buypakage.click_by_text("Chi tiết")
    buypakage.click_text_by_resource_id("vms.com.vn.mymobifone:id/tvCancelPackage")
...
def test_share_pakage_tc69(driver):
    ...
    buypakage.wait_for_result("Chia sẻ")
    assert buypakage.is_result_displayed("Chia sẻ")
