...
def test_search_package_tc03(driver):
    ...
    assert homepage.is_result_displayed("Funring")
#TC04 - Click Avata
@pytest.mark.tc04
...
def test_click_utilities_tc13_2(driver):
    homepage = HomePage(driver)
    homepage.click_infomation()
    homepage.scroll_to_element1("Tiện ích nổi bật")
...
@pytest.mark.tc16
def test_services_register_tc16(driver):
    homepage = HomePage(driver)
    homepage.search_package("Funring")
    homepage.wait_for_result("Funring")
    homepage.click_by_text("Funring")
    homepage.click_button_by_text("btn signed")
...
@pytest.mark.tc17
def test_services_unregister_tc17(driver):
    homepage = HomePage(driver)
    homepage.search_package("Funring")
    homepage.wait_for_result("Funring")
    homepage.click_button_by_text("Done")
    homepage.click_by_text("Funring")
    homepage.click_button_by_text("btn huy", 1)
    homepage.click_button_by_text("Đồng ý")
    homepage.input_otp("888888")
    homepage.wait_for_result("Huỷ dịch vụ")
    assert homepage.is_result_displayed("Gửi yêu cầu hủy thành công")
#=====GÓI CƯỚC CỦA BẠN=========()
#TC18 - Huỷ gói cước
@pytest.mark.tc18
...
def test_extend_pakage_tc19(driver):
    homepage = HomePage(driver)
    homepage.click_infomation()
    homepage.click_by_text("Gói cước quốc tế (1)")
    homepage.scroll_to_element2("Gia hạn gói cước")
    homepage.click_by_text("Data Roaming")   
...
def test_change_number_tc25(driver):
    ...
    homepage.click_by_text("0762203039")
...
def test_click_utilities_tc27(driver):
    ...
    homepage.click_button_by_text("arrow left")
...
def test_click_utilities_tc28(driver):
    homepage = HomePage(driver)
    homepage.click_by_text("Xem tất cả")
    # homepage.scroll_to_element2("Đổi Esim")
    homepage.click_by_text("Đổi Esim")
    homepage.click_button_by_text("icBack")
    homepage.click_by_text("Chuyển vùng quốc tế")
    homepage.click_button_by_text("arrow left roaming")
    ...
    assert homepage.is_result_displayed("Viễn thông")
...
def test_click_customer_support_tc31(driver):
    ...
    homepage.click_by_text("Chuẩn hoá thông tin", 2)
    homepage.click_button_by_text("icBack")
    homepage.click_by_text("Hòa mạng", 2)
    homepage.click_button_by_text("icBack")
    homepage.click_by_text("Phản ánh khách hàng")
    homepage.click_button_by_text("icBack")
    homepage.click_by_text("Zalo miniApp")
    homepage.wait_for_result("Zalo")
    assert homepage.is_result_displayed("Zalo")
...
def test_click_banner_tc32(driver):
    ...
    homepage.wait_for_result("Xong")
    assert homepage.is_result_displayed("Xong")
@pytest.mark.tc32_1   
